...
if(!empty($model->contract_id)) {
    ...
    $apply['contract']['partner'] = null;
    if (!empty($model->contract->partner))
...
$checkHistory = FlowService::getCheckLogModel($model->apply_id, $this->businessId);
...
$flowNode = FlowService::getNodeByNodeId($data['check_node_id']);
